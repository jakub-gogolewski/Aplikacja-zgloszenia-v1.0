 ...
 */
final class Version20240117224610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ALTER deleted DROP DEFAULT');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ALTER deleted SET DEFAULT false');
    }
}
