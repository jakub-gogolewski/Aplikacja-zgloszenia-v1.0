 ...
 */
final class Version20240127123127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE api_keys (id UUID NOT NULL, api_user_id UUID NOT NULL, PRIMARY KEY(id))');
