...
class getTwig_Command_DebugService extends App_KernelDevDebugContainer
{
    ...
    {
        $container->privates['twig.command.debug'] = $instance = new \Symfony\Bridge\Twig\Command\DebugCommand(($container->privates['twig'] ?? self::getTwigService($container)), 'C:\\duzy_projekt_programowanie', $container->parameters['kernel.bundles_metadata'], 'C:\\duzy_projekt_programowanie/templates', ($container->privates['debug.file_link_formatter'] ?? self::getDebug_FileLinkFormatterService($container)));
