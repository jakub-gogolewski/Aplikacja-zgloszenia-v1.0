...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('AaDA79FgaM', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m-Tjns8OuW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z0ui0wFd4O', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\duzy_projekt_programowanie\\src\\Entity'], true)), 'App\\Entity');
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wi5uHbW+j-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ywjHv0utiP', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yhhB8Gfb4E', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P6NOu5Nqvp', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('veIaCY-Mq7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I9AbwRVI9Q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mVUpEV9hBh', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\duzy_projekt_programowanie', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ar.xlf'], 'az' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ca.xlf'], 'cs' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.cs.xlf'], 'cy' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.de.xlf'], 'el' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.el.xlf'], 'en' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.en.xlf'], 'es' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.es.xlf'], 'et' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.fa.xlf'], 'fi' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.fi.xlf'], 'fr' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.fr.xlf'], 'gl' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.hu.xlf'], 'hy' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.id.xlf'], 'it' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.it.xlf'], 'ja' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ja.xlf'], 'lb' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mk' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.mk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.mk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.mk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.mk.xlf'], 'mn' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle+intl-icu.nl.xlf'], 'nn' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.pl.xlf'], 'pt' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.pt.xlf'], 'pt_BR' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ro.xlf'], 'ru' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ru.xlf'], 'sk' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.sk.xlf'], 'sl' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.tr.xlf'], 'uk' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.uk.xlf'], 'ur' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf'], 'sr' => ['C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.sr.xlf']], 'scanned_directories' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations', 'C:\\duzy_projekt_programowanie/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\framework-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\debug-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\twig-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\twig\\extra-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\monolog-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\maker-bundle\\src/translations'], 'cache_vary' => ['scanned_directories' => ['C:\\duzy_projekt_programowanie\\vendor\\symfony\\validator/Resources/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-core/Resources/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations', 'translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\framework-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\debug-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\twig-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\twig\\extra-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\monolog-bundle/translations', 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\maker-bundle\\src/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\duzy_projekt_programowanie');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\duzy_projekt_programowanie/templates');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\duzy_projekt_programowanie\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($f, 'C:\\duzy_projekt_programowanie', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\duzy_projekt_programowanie\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\duzy_projekt_programowanie',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SymfonyCastsVerifyEmailBundle' => [
                    'path' => 'C:\\duzy_projekt_programowanie\\vendor\\symfonycasts\\verify-email-bundle\\src',
            ...
            'translator.default_path' => 'C:\\duzy_projekt_programowanie/translations',
            ...
            'twig.default_path' => 'C:\\duzy_projekt_programowanie/templates',
