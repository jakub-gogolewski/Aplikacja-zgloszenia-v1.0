...
class __TwigTemplate_fa5f34a736e8cdce23e0b827990fa696 extends Template
{
    ...
    ";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 15, $this->source); })()), "imie", [], "any", false, false, false, 15), 'row');
        echo "
    ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 16, $this->source); })()), "nazwisko", [], "any", false, false, false, 16), 'row');
        echo "
        ";
        // line 17
...
";
    ...
    {
        return array (  139 => 24,  133 => 21,  130 => 20,  128 => 18,  124 => 17,  120 => 16,  116 => 15,  112 => 14,  107 => 12,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {{ form_row(registrationForm.imie) }}
    {{ form_row(registrationForm.nazwisko) }}
...
{% endblock %}
", "registration/register.html.twig", "C:\\Users\\GogolTech\\Desktop\\duzy_projekt_programowanie\\templates\\registration\\register.html.twig");
    }
}
